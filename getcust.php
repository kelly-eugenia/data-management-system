  ...
  if (isset($_POST['query'])) {
      if($_POST['query']=='') {
          $query = "SELECT * FROM customer";
            ...
            $query = "SELECT * FROM customer WHERE (custID LIKE '%{$_POST['query']}%') OR (custName LIKE '%{$_POST['query']}%') OR (custAddress LIKE '%{$_POST['query']}%') OR (custDelivAddr LIKE '%{$_POST['query']}%') OR (custContactP LIKE '%{$_POST['query']}%') OR (custPhone LIKE '%{$_POST['query']}%') OR (custNPWP LIKE '%{$_POST['query']}%')";
      }
